...
?>
<form action="funtion_ptb2.php" method="get" >
    <table width="806" border="1">
        ...
        <tr>
            <td colspan="4">
                ...
                <input name="textfield" type="text" id="textfield2" style="width: 700px" disabled value="<?php if (isset($nghiem)) echo $nghiem; ?>" /></tr>
        <tr>
